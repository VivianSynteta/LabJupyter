...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
                    figure=px.pie(
                    values=exp_rec,
                    names=recession_data['Vehicle_Type'].unique(),
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(tma, x='Month', y='Automobile_Sales', title='Monthly Automobile sales'))
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(
                     values=exp_data,
                     names=yearly_data['Vehicle_Type'].unique(),
                     title="Total Advertisement Expenditure share per vehicle"
                    ))
